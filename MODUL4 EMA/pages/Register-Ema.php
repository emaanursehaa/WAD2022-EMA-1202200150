...
if (isset($_POST["daftar"])) {
  ...
  if (mysqli_num_rows(($result)) !== 1 && $password == $pwdConfirm) {
    ...
    echo "<meta http-equiv='refresh' content='2 url=Login-Ema.php'>";
            ...
            <form action="" method="post">
              ...
              <div class="form-outline mb-4">
                ...
                <div class="text-center text-lg-start mt-4 pt-2">
                  ...
                  <p class="small fw-bold mt-2 pt-1 mb-0">anda sudah punya akun? <a href="Login-Ema.php" class="link-danger">Login</a></p>
                </div>
            </form>
          </div>
        </div>

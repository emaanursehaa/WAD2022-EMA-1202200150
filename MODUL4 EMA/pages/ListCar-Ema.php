...
<body>
  ...
  <nav class="navbar navbar-expand navbar-dark bg-<?= isset($_COOKIE["warna_navbar"])  ? $_COOKIE["warna_navbar"] : "success"; ?>">
    <div class="container py-2">
      <div class="navbar-nav">
        ...
        <a class="nav-link" href="<?php (mysqli_num_rows($result) > 0) ? print "./ListCar-Ema.php" : print "./Add-Ema.php" ?>">MyCar</a>
      </div>
      <div class="d-flex">
        <a href="./Add-Ema.php" class="btn btn-light text-<?= isset($_COOKIE["warna_navbar"])  ? $_COOKIE["warna_navbar"] : "success"; ?>" role="button">Add Car</a>
        <div class="dropdown ms-4">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item text-<?= isset($_COOKIE["warna_navbar"])  ? $_COOKIE["warna_navbar"] : "success"; ?>" href="./Profile-Ema.php">Profile</a></li>
  ...
  <section id="list">
    <div class="container">
      <div>
        <h1>My Show Room</h1>
        <p>List Show Room Ema - 1202200150</p>
        <div class="d-flex gap-5">
          ...
          if (mysqli_num_rows($result) > 0) {
            ...
            <div class='card-body'>
              ...
              <span class='d-flex'>
                <a href='Detail-Ema.php?id=" . $row["id_mobil"] . "' class='btn btn-primary' style='border-radius: 100px; width:140px; height: 36px;'>Detail</a>
